...
buttonRender: document.querySelector('#controls button[data-action="render"]'),
buttonDestroy: document.querySelector('#controls button[data-action = "destroy"]'),
...
refs.buttonDestroy.addEventListener('click', onTargetButtonDestroyClick);
 ...
 function createBoxes(amount){
   ...
   blockEl.setAttribute('style', 'background-color: ' + getRandomInt()+';'+'width:'+ width +'px;'+'height:'+ height+'px;');
   width +=10;
   height +=10;
   console.log()
